...
class Command(BaseCommand):
    help = 'Projected sameday turns for a given date in format YY-MM-DD'
    ...
    def handle(self, *args, **options):
        try:
            ...
            result = Turn.projected_sameday_turns(requested_date)
            print(f'Projected sameday turns for date {requested_date}: {result}')
